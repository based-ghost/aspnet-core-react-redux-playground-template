...
const NavBar: React.FC<{ isAuthenticated: boolean; }> = (props) => {
    const navRoutes = props.isAuthenticated && (
        <React.Fragment>
            <NavLink exact={true} to={RoutesConfig.Form.path} className='navbar-item' activeClassName='is-active'>
                <FontAwesomeIcon icon={RoutesConfig.Form.icon as IconProp} />{RoutesConfig.Form.displayName}
            </NavLink>
            <NavLink exact={true} to={RoutesConfig.Dashboard.path} className='navbar-item' activeClassName='is-active'>
                <FontAwesomeIcon icon={RoutesConfig.Dashboard.icon as IconProp} />{RoutesConfig.Dashboard.displayName}
            </NavLink>
            <NavLink exact={true} to={RoutesConfig.FetchData.path} className='navbar-item' activeClassName='is-active'>
                <FontAwesomeIcon icon={RoutesConfig.FetchData.icon as IconProp} />{RoutesConfig.FetchData.displayName}
            </NavLink>
        </React.Fragment>
    );
